...
public class ForexMainActivity extends AppCompatActivity {
    ...
    private void bindRecyclerView() {
        String ratesUrl = "https://openexchangerates.org/api/latest.json?app_id=c7eff48603c74fc0a361c576f8ead850";
                    ...
                    client.get(currencyUrl, new AsyncHttpResponseHandler() {
                        ...
                        public void  onSuccess(int statusCode, Header[] headers, byte[] responseBody){
                            try {
                                ...
                                Toast.makeText(ForexMainActivity.this, "Gagal parsing data mata uang", Toast.LENGTH_SHORT).show();
                            }
