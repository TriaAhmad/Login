...
public class TampilMahasiswaActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_mahasiswa_activty);
    ...
    private void filter(String text){
        ...
        if (filteredList.isEmpty()) {
            Toast.makeText(TampilMahasiswaActivty.this, "No Data Found...", Toast.LENGTH_SHORT).show();
    ...
    private  void  loadRecyclerView() {
        ...
        ahc.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                RecyclerView.LayoutManager lm = new LinearLayoutManager(TampilMahasiswaActivty.this);
